...
#define IOCTL_GPU_TEST _IO( IOCTL_GPU_MAGIC , 0)
#define IOCTL_GPU_READ _IOR( IOCTL_GPU_MAGIC , 1, gpu_umsg)
#define IOCTL_GPU_WRITE _IOW( IOCTL_GPU_MAGIC , 2, gpu_umsg)
#define IOCTL_GPU_MAXNR 3
...
{
/*	int dev, state;
	if((dev = open("/dev/mali0", O_RDWR|O_NDELAY))<0){
		printf("ERROR:Device file opne\n");
		return 0;
	}
*/
